      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-slate-50">
        <div className="w-full max-w-md">
          ...
          {authLoading ? (
            ...
            <>
              <h2 className="text-2xl font-bold text-navy-950 mb-1">Link expired</h2>
              <p className="text-slate-500 mb-8">
                This password reset link is invalid or has expired. Request a new one below.
              </p>
              <Link
                to="/forgot-password"
                className="inline-block py-2.5 px-4 bg-navy-950 hover:bg-navy-800 text-white text-sm font-semibold rounded-lg transition-colors"
              >
                Request a new link
              </Link>
            </>
            ...
            <>
              <h2 className="text-2xl font-bold text-navy-950 mb-1">Set a new password</h2>
